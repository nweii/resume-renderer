...
**Canonical content**:
The variant's content file: JSON, or markdown in the dialect (`docs/markdown-dialect.md`). Every other editing surface is a convenience that reconciles back to it.
