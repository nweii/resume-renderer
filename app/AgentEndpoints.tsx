...
export function AgentEndpoints({ variant }: { variant: ResumeVariant }) {
  ...
  // The footer inherits the page's body color rather than reading a template's
  // theme variable: it sits outside the document and has to look right under
  // every template.
  return (
    <footer className="mt-4 text-center text-[8.5pt] opacity-70 print:hidden">
